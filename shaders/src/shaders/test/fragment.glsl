...
// {
    ...
    // pattern 24
    // float strength=floor(vUv.x*10.0)/10.0 ;
    // strength=random(vec2(strength,floor(vUv.y*10.0 +vUv.x)/10.0));
    // pattern 25
    ...
    // pattern 31
    // vec2 rot=rotate(vUv,1.0,vec2(0.5));
    // float strength=0.15/distance(vec2(rot.x,(rot.y-0.5)*5.0+0.5),vec2(0.5)) ;
    // strength*=0.15/distance(vec2((rot.x-0.5)*5.0+0.5,rot.y),vec2(0.5)) ;
    // pattern 32
    // vec2 rot=rotate(vUv,PI*0.25,vec2(0.5));
    // float strength=0.15/distance(vec2(rot.x,(rot.y-0.5)*5.0+0.5),vec2(0.5)) ;
    // strength*=0.15/distance(vec2((rot.x-0.5)*5.0+0.5,rot.y),vec2(0.5)) ;
    // pattern 33
    ...
    // pattern 37
    // float strength=1.0-step(0.01,abs(distance(vec2(vUv.x,vUv.y+sin(vUv.x*30.0)*0.2),vec2(0.5))-0.25));
    // pattern 39
    ...
    // angle+=0.5;
    // angle = sin(angle*100.0);
    // float rad=0.25+angle *0.02;
    // float strength= 1.0-step(0.01,abs(distance(vUv,vec2(0.5))-rad));
    // pattern 46
